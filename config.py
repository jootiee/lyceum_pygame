...
BLOCK_ASSETS = {'ground': os.path.join(blocks, 'ground.png'),
                ...
                '0': os.path.join(assets, 'trail.png'),
                '*': os.path.join(assets, 'sand.png'),
                '1': os.path.join(assets, 'stone_2.png'),
                '2': os.path.join(assets, 'trail_2.png'),
                '&': os.path.join(assets, 'water.png'),
                '?': os.path.join(assets, 'water_with_stone.png'),
                '=': os.path.join(assets, 'lava.png'),
                '#': os.path.join(assets, 'bush.png'),
                '3': os.path.join(assets, 'snow.png'),
